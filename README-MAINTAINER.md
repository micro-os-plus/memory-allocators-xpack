...
- name the post like: **µOS++ memory-allocators v1.1.0 released**
...
- `npm dist-tag add @micro-os-plus/memory-allocators@1.1.0 latest`
- `npm dist-tag ls @@micro-os-plus/memory-allocators`
...
- paste the release name like **µOS++ memory-allocators v1.1.0 released**
