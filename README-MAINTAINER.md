...
In the `micro-os-plus/memory-allocators-xpack` Git repo:
...
- <https://github.com/micro-os-plus/memory-allocators-xpack/issues/>
...
```sh
xpm run install-all -C ~/Work/micro-os-plus/memory-allocators-xpack.git
xpm run test-all -C ~/Work/micro-os-plus/memory-allocators-xpack.git
```
